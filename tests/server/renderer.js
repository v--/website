...
describe('Server-side render', function() {
    ...
    it('Properly renders a div with multiple nested component', function() {
        ...
        expect(render(component)).to.equal('<div><span>nested1</span><span>nested2</span></div>');
    });
    ...
    it('Properly renders a div with multiple mixed component', function() {
        ...
        expect(render(component)).to.equal('<div>nested1<span>nested2</span></div>');
    });
    ...
    it('Allows passing options to components', function() {
        ...
        expect(render(component)).to.equal('<div><span></span></div>');
    });

    it('Properly transcludes components', function() {
        const factory = ({ contents }) => c('div', null, ...contents);
