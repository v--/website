...
/**
 * @template T
 * @implements TContainers.IBinaryHeap<T>
 */
export class BinaryHeap {
  /** @param {TContainers.IBinaryHeapParams<T>} state */
  ...
  pop() {
    ...
    if (this.payload.length === 1) {
      this.payloadMap.delete(/** @type {T} */ (this.payload.pop()))
      this.weights.pop()
    } else {
      this.payloadMap.delete(this.payload[0])
      this.weights[0] = /** @type {TNum.Float64} */ (this.weights.pop())
      this.payload[0] = /** @type {T} */ (this.payload.pop())
