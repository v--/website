import { dividedDifferences } from './divided-differences.ts'
import { type KnotMapping } from './knot-mapping.ts'
import { type float64 } from '../../types/numbers.ts'
import { UnivariatePolynomial, ZERO_POLYNOMIAL } from '../algebra/univariate-polynomial.ts'
