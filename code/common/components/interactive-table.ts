...
import { verticalTable } from './vertical-table.ts'
import { type WebsiteEnvironment } from '../environment.ts'
import { createComponent as c } from '../rendering/component.ts'
import { classlist } from '../support/dom-properties.ts'
import { QueryConfig } from '../support/query-config.ts'
import { getNextSortParams, parsePage, parsePerPage, parseSortStatus, sliceData } from '../support/table-interaction.ts'
...
import { type IVerticalTableColumnSpec } from '../types/vertical-table.ts'
...
function mapColumnSpec<T>(
  ...
  return {
    ...
    header: () => c.factory(
      ...
      c.factory(icon, { libId: 'interactive-table', name: getSvgIconFromDirection(direction) }),
