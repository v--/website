declare namespace Components {
  ...
  export type FactoryComponentType<T> = (state: Observables.BaseType<T>, children: IComponent[]) => IComponent

  export type IPotentialComponent = IComponent | null | undefined | boolean | number | string
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  export type IComponentStateSource<T = any> = ComponentStateType<T> | Observables.IObservable<ComponentStateType<T>>
