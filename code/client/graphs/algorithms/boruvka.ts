...
function addSafe<T>(graph: Graph<T>, tree: Graph<T>, components: GraphComponentMap<T>, componentCount: TNum.UInt32) {
  const safe = new Map<TNum.UInt32, GraphArc<T>>()
...
export const boruvka: GraphAlgorithm<TNum.UInt32> = Object.freeze({
  ...
  run<T extends TNum.UInt32>(graph: Graph<T>, _start?: T, _end?: T) {
