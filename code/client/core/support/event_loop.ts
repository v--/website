...
export class EventLoop {
  private listenerMap = new Map<Action<void>, number>()
  private subscriptionMap = new Map<Action<void>, Subscription<void>>()
  private started = false

  add(listener: Action<void>, period: number) {
