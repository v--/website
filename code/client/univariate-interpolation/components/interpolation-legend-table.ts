...
import { verticalTable } from '../../../common/components/vertical-table.ts'
      ...
      columnSpecs: [
        {
          id: 'method',
          class: 'col-method',
          label: { bundleId: 'univariate-interpolation', key: 'legend-table.heading.method' },
          value({ interpolator }: IInterpolatedFunction) {
            ...
            return c.factory(checkbox, {
              ...
              text: _(`legend-table.interpolator.${interpolator.id}.name`),
        ...
        {
          id: 'expression',
          label: { bundleId: 'univariate-interpolation', key: 'legend-table.heading.expression' },
