...
import { playgroundMenu } from '../core/components/playground-menu.ts'
import { type ClientWebsiteEnvironment } from '../core/environment.ts'
import { sortingCard } from './components/sorting-card.ts'
...
export function indexPage(pageState: IWebsitePageState, env: ClientWebsiteEnvironment) {
  const _ = env.gettext.bindToBundle('array-sorting')
      ...
      doc: _.rich$(
        {
          ...
          context: {
            ...
            githubPageUrl: `${GITHUB_PROJECT_CODE_URL}/client/array-sorting`,
          },
        },
      ),
    }),
